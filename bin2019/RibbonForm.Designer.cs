namespace JEast
{
	partial class RibbonForm
	{
		...
		private void InitializeComponent()
		{
			...
			// barStaticItem2
			// 
			this.barStaticItem2.Caption = "根用户";
			...
			this.bs_version.Caption = "19.0704001";
			this.bs_version.Id = 4;
			this.bs_version.Name = "bs_version";
			// 
			// barHeaderItem2
			// 
			this.barHeaderItem2.Caption = "          使用单位:";
			this.barHeaderItem2.Id = 5;
			this.barHeaderItem2.Name = "barHeaderItem2";
			// 
			// barStaticItem4
			// 
			this.barStaticItem4.Caption = "佳木斯东郊殡仪馆";
			...
			// barButtonItem2
			// 
			this.barButtonItem2.Caption = "切换用户";
			...
			// barButtonItem3
			// 
			this.barButtonItem3.Caption = "进灵登记";
			...
			// barButtonItem4
			// 
			this.barButtonItem4.Caption = "登记浏览";
			...
			// barButtonItem5
			// 
			this.barButtonItem5.Caption = "火化业务办理";
			...
			// barButtonItem6
			// 
			this.barButtonItem6.Caption = "临时性销售";
			...
			// barButtonItem7
			// 
			this.barButtonItem7.Caption = "出灵数据查询";
			...
			// barButtonItem9
			// 
			this.barButtonItem9.Caption = "火化安排";
			...
			// barButtonItem11
			// 
			this.barButtonItem11.Caption = "数据项维护";
			...
			// barButtonItem12
			// 
			this.barButtonItem12.Caption = "商品服务及定价";
			...
			// barButtonItem13
			// 
			this.barButtonItem13.Caption = "服务套餐维护";
			...
			// barButtonItem14
			// 
			this.barButtonItem14.Caption = "寄存结构维护";
			...
			// barButtonItem15
			// 
			this.barButtonItem15.Caption = "升级文件上传";
			...
			// barButtonItem16
			// 
			this.barButtonItem16.Caption = "关于系统";
			...
			this.barButtonItem17.Caption = "版本号:";
			this.barButtonItem17.Id = 23;
			this.barButtonItem17.Name = "barButtonItem17";
			// 
			// barButtonItem18
			// 
			this.barButtonItem18.Caption = "操作员管理";
			...
			// barButtonItem20
			// 
			this.barButtonItem20.Caption = "权限分配";
			...
			// barButtonItem21
			// 
			this.barButtonItem21.Caption = "税务发票基础信息";
			...
			// barButtonItem8
			// 
			this.barButtonItem8.Caption = "进灵登记查询";
			...
			// barButtonItem22
			// 
			this.barButtonItem22.Caption = "寄存办理";
			...
			// barButtonItem23
			// 
			this.barButtonItem23.Caption = "寄存室数据";
			...
			// barButtonItem25
			// 
			this.barButtonItem25.Caption = "寄存办理";
			...
			// barButtonItem26
			// 
			this.barButtonItem26.Caption = "寄存室数据";
			...
			// barButtonItem27
			// 
			this.barButtonItem27.Caption = "欠费数据统计";
			...
			this.barButtonItem27.RibbonStyle = DevExpress.XtraBars.Ribbon.RibbonItemStyles.SmallWithText;
			this.barButtonItem27.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.BarButtonItem27_ItemClick);
			// 
			// barButtonItem28
			// 
			this.barButtonItem28.Caption = "迁出查询";
			...
			// barButtonItem29
			// 
			this.barButtonItem29.Caption = "原始登记查询";
			...
			this.barButtonItem29.RibbonStyle = DevExpress.XtraBars.Ribbon.RibbonItemStyles.SmallWithText;
			this.barButtonItem29.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.BarButtonItem29_ItemClick);
			// 
			// barButtonItem30
			// 
			this.barButtonItem30.Caption = "操作员管理";
			...
			// barButtonItem31
			// 
			this.barButtonItem31.Caption = "角色管理";
			...
			// barButtonItem32
			// 
			this.barButtonItem32.Caption = "权限分配";
			...
			// barButtonItem33
			// 
			this.barButtonItem33.Caption = "连接税务金卡";
			this.barButtonItem33.Id = 41;
			...
			// barButtonItem34
			// 
			this.barButtonItem34.Caption = "每日收费明细";
			this.barButtonItem34.Id = 42;
			...
			// barButtonItem35
			// 
			this.barButtonItem35.Caption = "类别统计";
			...
			// barButtonItem36
			// 
			this.barButtonItem36.Caption = "单项统计";
			...
			// barButtonItem37
			// 
			this.barButtonItem37.Caption = "收款员统计";
			...
			// barButtonItem38
			// 
			this.barButtonItem38.Caption = "收款作废查询";
			...
			// barButtonItem39
			// 
			this.barButtonItem39.Caption = "价格改动查询";
			...
			this.ribbonPageGroup8.Text = "寄存业务";
			// 
			// ribbonPage3
			// 
			...
			this.ribbonPageGroup4.ItemLinks.Add(this.barButtonItem37);
			this.ribbonPageGroup4.ItemLinks.Add(this.barButtonItem38, true);
			...
			this.ribbonPage5.Text = "系统维护";
			// 
			// ribbonPageGroup3
			// 
			this.ribbonPageGroup3.ItemLinks.Add(this.barButtonItem30);
			this.ribbonPageGroup3.ItemLinks.Add(this.barButtonItem31);
			this.ribbonPageGroup3.ItemLinks.Add(this.barButtonItem32);
			this.ribbonPageGroup3.Name = "ribbonPageGroup3";
			this.ribbonPageGroup3.Text = "操作员及权限";
			// 
			// ribbonPageGroup6
			// 
			...
			this.ribbonStatusBar.ItemLinks.Add(this.barButtonItem17);
			...
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.RibbonForm_FormClosed);
